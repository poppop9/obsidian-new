...
| ------------ | ---- | ---------------- |
| **parent**   | 上位概念 | **它属于什么？**       |
| **children** | 下位概念 | **它可以拆成什么？**     |
| **requires** | 前置知识 | **理解它之前必须知道什么？** |
| **similar**  | 同类思想 | **还有什么在解决类似问题？** |
| **opposes**  | 对立观点 | **什么观点与它相反？**    |
| **source**   | 来源   | **我是从哪里学到的？**    |
| **author**   | 提出者  | **是谁提出或主要传播了它？** |
# 未整理
能给你带来思考的，放到 Source；不能带来思考的，放到 Reference
