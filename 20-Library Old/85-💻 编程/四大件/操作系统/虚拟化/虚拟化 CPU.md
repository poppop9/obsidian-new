...
## 进程不受限的直接执行
![](https://obsidian-1307744200.cos.ap-guangzhou.myqcloud.com/%E5%9B%BE%E7%89%87/20260309135552334.png)
...
> 系统调用发起后，程序会将系统调用号和参数传递给操作系统内核，内核会根据系统调用号来执行相应的 _**内核代码**_ 来完成这些操作
