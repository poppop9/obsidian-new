...
docker run -d \
  ...
  -e KAFKA_LISTENERS=BROKER://:9092,CONTROLLER://:9093 \
  -e KAFKA_ADVERTISED_LISTENERS=BROKER://localhost:9092 \
  ...
  -e CLUSTER_ID=big-market-cluster \
  apache/kafka:4.1.1

docker run -d --name kafka -p 9092:9092 -p 9093:9093 -e KAFKA_NODE_ID=0 -e KAFKA_PROCESS_ROLES=controller,broker -e KAFKA_INTER_BROKER_LISTENER_NAME=BROKER -e KAFKA_CONTROLLER_LISTENER_NAMES=CONTROLLER -e KAFKA_LISTENERS=BROKER://:9092,CONTROLLER://:9093 -e KAFKA_ADVERTISED_LISTENERS=BROKER://localhost:9092 -e KAFKA_LISTENER_SECURITY_PROTOCOL_MAP=CONTROLLER:PLAINTEXT,BROKER:PLAINTEXT -e KAFKA_CONTROLLER_QUORUM_VOTERS=0@localhost:9093 -e CLUSTER_ID=big-market-cluster apache/kafka:4.1.1
