...
- 中文字体：宋体
- 三级标题：三级标题序号 Times New Roman、小四，中文 黑体、小四，左对齐。标题序号和标题之间空1格。段落设置中，首行缩进2字符，间距段前断后各1行，单倍行距

# gpt 提问资料
我是写论文，请改为文章的段落形式，不要分点的列表形式
...
# 开题答辩
开题说白了就是让你写文献综述，要多看论文增加对你研究领域的认知

ppt 8-15 页

四个大方面：
1. 立题依据 ：课题来源、选题背景、研究目的、理论意义、实际应用价值
2. 文献综述 ：论文各论点的研究现状列举
3. 研究内容 ：主要研究内容、拟解决的关键技术、拟采取的研究方法、技术路线和实施方案、可行性分析、预期目标、创新点
4. 工作计划 ：一张 内容 工作量 起止日期 阶段性成果形式 的表格
