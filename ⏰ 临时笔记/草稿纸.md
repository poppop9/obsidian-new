...
12. **万华化学（广东）**（珠海）
13. **广药集团**（广州）
    - 中国最大中成药生产基地，旗下有王老吉、白云山等品牌
14. **华大基因**（深圳）
    - 全球领先的生命科学前沿机构，专注基因测序与精准医疗。
15. **顺丰速运**（深圳）
    - 中国快递物流行业龙头企业，布局国际供应链业务。
- **新兴产业**：可关注深圳-东莞的电子信息产业带、广州-佛山的新能源汽车集群、珠海-中山的生物医药布局。

# hfs
我的组件包含关系 ：App.jsx 中包含 Header、Main、Footer，Main 中包含 RaffleMain、ActivityMain、RewardMain
...
<div className={"flex items-center"}>付费购买</div>

<div className={"flex items-center"}>2025-03-21 23:48:35</div>
...
<div className={"flex items-center"}>2025-03-22 23:48:35</div>
...
<div className={"flex items-center"}>2025-03-23 23:48:35</div>
...
改为动态生成数据，通过 get 请求：/api/activity/v1/findAllPendingPaymentAO，json 结构：
...
"activityOrderId": 1926311012259524608,

"activityOrderTypeId": 1910937768264691714,
...
"activityOrderEffectiveTime": "2025-05-25T00:15:09.107424",

"activityOrderExpireTime": "9999-12-31T23:59:59",

"activityOrderStatus": "PENDING_PAYMENT"
