...
| 快捷键                      | 功能              |
| ------------------------ | --------------- |
| `Command + 空格`           | 聚焦搜索（Spotlight） |
| `Command + H`            | 隐藏当前窗口          |
| `Command + M`            | 最小化当前窗口         |
| `Command + Option + Esc` | 强制退出程序管理器       |
...
| `Command + Backspace`  | 将文件移到废纸篓       |
| `Command + Option + V` | 移动已复制的文件（剪切粘贴） |
...
| `Command + T`           | 新建标签页    |
| `Command + W`           | 关闭当前标签页  |
| `Command + Shift + N`   | 新建无痕窗口   |
| `Command + R`           | 刷新页面     |
| `Command + Shift + R`   | 清除缓存强制刷新 |
| `Command + L`           | 光标跳转到地址栏 |
| `Command + F`           | 页面内查找    |
| `Command + +`           | 放大页面     |
| `Command + -`           | 缩小页面     |
