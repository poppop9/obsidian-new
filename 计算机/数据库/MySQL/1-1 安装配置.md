...
docker run -d --name mysql -p 3306:3306 -e TZ=Asia/Shanghai -e MYSQL_ROOT_PASSWORD=root -v mysql_volume:/var/lib/mysql mysql:8.4 mysqld --mysql-native-password=ON
```
